...
$S_{7,p}$ or $S_{6,p}$. The local non-Abelian flavor lattice is the root
...
as in \eqref{eq:e3-roots}. Gauging a flavor isometry couples the
...
\begin{equation}
 ...
 \qquad
 \cB_{p,\mathfrak{sl}_2}=(\cB_{\mathfrak{sl}_2})_p=\CC_{L_p},
 \quad
 \cB_{p,\mathfrak{sl}_3}=(\cB_{\mathfrak{sl}_3})_p
 =\CC^2_{H_{p1},H_{p2}}.
...
span $H^2(\wideX;\QQ)$, which on the admissible class of
Section~\ref{subsec:admissible-class} the restricted ambient toric divisors
do. Its dual records one complex moment-map equation for each vector
...
use the balanced rank-one ADHM representatives described after
\eqref{eq:e3-roots}. Every local real Cartan moment map then vanishes
