...
original cooperative constraint. In both limits the volume-normalized
K\"ahler class tends to a face on which the whole del Pezzo surface has
zero volume. In the interior of the face of the nef cone on which only
$C_1$, $C_2$, $e_1$ and $e_2$ have zero area, the four states are
massless five-dimensional hypermultiplets and the smoothing of the
resulting four-node threefold has as general fibre a smoothing of $X_9$
in the joint direction, deformation equivalent to $X_{9,t}$; its
finite-Planck Higgs branch is treated in~\cite{Wuebben:2026finiteplanck}.
