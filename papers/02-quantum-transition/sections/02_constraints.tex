...
The companion paper \cite[Sections~2--4]{wuebben2026globalconstraints} also proves
the physical dictionaries for the degree-eight $\mathbb P^1\times\mathbb P^1$
cone ($E_1$) and the degree-five cone ($E_4$), with an intrinsic
comparison using all compact divisor classes. Here we retain the
node/$E_2$/$E_3$ specialization, since the quantum transition studied
below contains only two nodes and one $E_2$ point.
