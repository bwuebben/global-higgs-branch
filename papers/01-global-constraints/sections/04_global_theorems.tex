...
where the nearby fiber remains singular. At a node, an $E_2$ point or an
...
summands. The following is the degree-six/seven specialization of the
...
nodes and exact analytic anticanonical cones over $S_7$ or $S_6$.
...
plane. Necessity applies to arbitrary analytic smoothing arcs, without
...
their sum is zero in the del Pezzo marking. The rank-one period argument
treats the other germs. A generic rational linear combination of the
...
specialization of \cite[Theorem~4.5]{Wuebben:2026smoothing} concerns this
...
three nodes. The partial model has an unobstructed deformation space;
...
For the admissible toric class, Proposition~\ref{prop:physical-kernel}
...
over $\mathbb P^1\times\mathbb P^1$: their conditions are five nonzero
conic-pencil pairings and a nonzero ruling-difference coefficient,
respectively \cite[Section~1.2]{Wuebben:2026smoothing}. Extending the physical
operator dictionary to those sectors is separate from the node/$E_2$/$E_3$
