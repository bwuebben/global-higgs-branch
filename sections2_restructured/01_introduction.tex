...
The geometric local-to-global statements and the construction
of the smoothing are established in the companion mathematical
work \cite{Wuebben:2026obstruction,Wuebben:2026smoothing};
we recall the necessary hypotheses and proofs of the local
identifications. The invariant image is not the full
